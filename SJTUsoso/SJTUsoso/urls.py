...
urlpatterns = [
    ...
    path('new_resource/', tonew_resource,name="new_resource"),
    ...
    path('del_new_resource/<int:new_id>/', to_del_new,name="del_new_resource"),
    path('del_video_comment/<int:comment_id>/', to_del_comment,name="del_video_comment"),
    ...
    path('post_words/',words_post,name="post_words"),
